package com.hyh.mallchat.transaction.domain.entity;
...
public class SecureInvokeRecord {
     ...
     * 请求快照参数json
     */
    @TableField(value = "secure_invoke_json", typeHandler = JacksonTypeHandler.class)//JacksonTypeHandler 识别json格式
