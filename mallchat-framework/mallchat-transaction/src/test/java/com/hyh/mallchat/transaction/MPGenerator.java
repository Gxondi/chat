package com.hyh.mallchat.transaction;
...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/mallchat-framework/mallchat-transaction/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("CondiX");
        ...
        packageConfig.setParent("com.hyh.mallchat.transaction");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://192.168.6.101:3306/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}