...
import com.hyh.mallchat.common.chat.domain.entity.msg.FileMsgDTO;
...
public class FileMsgHandler extends AbstractMsgHandler<FileMsgDTO> {
    ...
    @Override
    public void checkMsg(FileMsgDTO body, Long roomId, Long uid) {

    }

    @Override
    public void saveMsg(Message message, FileMsgDTO body) {
