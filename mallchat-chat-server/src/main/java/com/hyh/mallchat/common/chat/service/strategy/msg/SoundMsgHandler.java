...
import com.hyh.mallchat.common.chat.domain.entity.msg.SoundMsgDTO;
...
public class SoundMsgHandler extends AbstractMsgHandler<SoundMsgDTO> {
    ...
    @Override
    public void checkMsg(SoundMsgDTO body, Long roomId, Long uid) {

    }

    @Override
    public void saveMsg(Message message, SoundMsgDTO body) {
