...
public class WxPortalController {
    ...
    @GetMapping("/test")
    public String getQrCode(@RequestParam("code") String code) throws WxErrorException {
        WxMpQrCodeTicket wxMpQrCodeTicket = wxService.getQrcodeService().qrCodeCreateTmpTicket(code, 100000);
    ...
    public RedirectView callBack(@RequestParam String code) {
        ...
        redirectView.setUrl("http://www.mallchat.cn");
        return redirectView;
    }
